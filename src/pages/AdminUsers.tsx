  ...
  return (
    <div>
      ...
      <div className={shared.section}>
        <p className={shared.textSmall} style={{ color: '#666', marginBottom: 16 }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ borderBottom: '1px solid #e0e0e0' }}>
              <th style={{ textAlign: 'left', padding: '10px 12px', fontSize: 13, fontWeight: 500, color: '#999' }}>用户</th>
              <th style={{ textAlign: 'left', padding: '10px 12px', fontSize: 13, fontWeight: 500, color: '#999' }}>角色</th>
              <th style={{ textAlign: 'left', padding: '10px 12px', fontSize: 13, fontWeight: 500, color: '#999' }}>注册时间</th>
              <th style={{ textAlign: 'right', padding: '10px 12px', fontSize: 13, fontWeight: 500, color: '#999' }}>操作</th>
            </tr>
          </thead>
          <tbody>
            {users.map(u => (
